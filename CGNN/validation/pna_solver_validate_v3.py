...
# coding: utf-8
"""
ImplicitPNASolver Validation Code v3
─────────────────────────────────────
v2 대비 추가:
...
def run_training(data, target_mp_val=2_500_000, max_epochs=300, lr=1e-3,
                 grad_check_interval=50, snapshot_interval=50):
    """
    ...
    for epoch in range(max_epochs):
        ...
        # ── v3 신규: 스냅샷 저장 (snapshot_interval마다) ──
...
def visualize_epoch_snapshots(snapshots, base_coords, target_mp_val):
    """
...
if __name__ == "__main__":
    ...
    history, base_coords, result_coords = run_training(
        ...
        snapshot_interval=50,   # v3: 50 epoch마다 스냅샷
    )
    ...
    visualize_epoch_snapshots(history['snapshots'], base_coords.cpu(), TARGET_MP)
